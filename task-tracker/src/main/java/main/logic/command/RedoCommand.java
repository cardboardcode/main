...
/**
 * Redoes the previous undo'd command. Pops from redo stack and executes
 * appropriate add/del/edit/clr commands
 * 
 */
public class RedoCommand extends Command {
	...
	private void redoEdit(Task newTask, Task originalTask)
			throws DuplicateTaskException, IndexOutOfBoundsException, TaskNotFoundException {
